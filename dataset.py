...
class VITONDataset(data.Dataset):
    def _init_(self, opt):
        super(VITONDataset, self)._init_()
...
class VITONDataLoader:
    def _init_(self, opt, dataset):
        super(VITONDataLoader, self)._init_()
        ...
        self.data_iter = self.data_loader._iter_()

    def next_batch(self):
        try:
            batch = self.data_iter._next_()
